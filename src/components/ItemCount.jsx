  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      ...
      <button
        ...
        className="w-full lg:w-auto bg-primary text-white px-6 py-2 rounded-lg shadow-md hover:bg-secundary focus:outline-none focus:ring-2 focus:ring-secundary transition duration-200"
      >
        Agregar al carrito
      </button>
    </div>
